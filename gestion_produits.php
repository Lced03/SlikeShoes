...
$content .= "<hr>";
 ...
 <div class="text-center">
     ...
     <form method="post" action="" enctype="multipart/form-data">
         ...
         <textarea name="description" id="description" cols="30" rows="10" placeholder="La description du produit"
         ...
         <label for="poiture">pointure</label>
         ...
         <select name="public" id="public" class="form-control">
             <option <?php if($public == 'e' ) echo 'selected' ?> value="m">Enfant</option>
             <option <?php if($public == 'f' ) echo 'selected' ?> value="f">Femme</option>
         </select>

         <label for="photo">Photo</label>
         <input type="file" name="photo" id="photo" class="form-control" value="<?php if(!empty($photo)) : ?>
        img src =" <?= $photo ?>" width="100">
         <?php endif; ?>

         <label for="prix"> Prix</label>
         <input type="text" name="prix" id="prix" placeholder="prix" class="form-control" value="<?= $prix ?>">

         <label for="stock">Notre stock</label>
         <input type="text" name="stock" id="stock" class="form-control" value="<?= $stock ?>">

         <input type="submit" value="enregistrer le produit" class="btn btn-success">
