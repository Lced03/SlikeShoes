...
{
    creationPanier();
    // on recherche si l'id du produit qu'on ajoute dans le panier se trouve déja dans le session
    $position_produit = array_search($id_produit, $_SESSION['panier']['id_produit']);

    if($position_produit !== false) // produit existe dans le panier
    {
